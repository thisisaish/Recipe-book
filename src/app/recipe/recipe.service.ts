...
export class RecipeService{
    ...
    recipes: Recipe[] = [
        ...
        new Recipe('Mutton Kola Urundai','Kola Balls or Kola Urundai in the local language, is one of the crunchiest South-Indian delicacies.','https://www.avacare.in/images/recipes/madurai_mutton_kola_urundai.jpg'),
